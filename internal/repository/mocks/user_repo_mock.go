...
// CountUsers provides a mock function for the type MockUserRepo
func (_mock *MockUserRepo) CountUsers(ctx context.Context, status string) (int, error) {
...
// MockUserRepo_CountUsers_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CountUsers'
type MockUserRepo_CountUsers_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - status string
func (_e *MockUserRepo_Expecter) CountUsers(ctx any, status any) *MockUserRepo_CountUsers_Call {
	return &MockUserRepo_CountUsers_Call{Call: _e.mock.On("CountUsers", ctx, status)}
}

func (_c *MockUserRepo_CountUsers_Call) Run(run func(ctx context.Context, status string)) *MockUserRepo_CountUsers_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockUserRepo_CountUsers_Call) Return(n int, err error) *MockUserRepo_CountUsers_Call {
	_c.Call.Return(n, err)
	return _c
}

func (_c *MockUserRepo_CountUsers_Call) RunAndReturn(run func(ctx context.Context, status string) (int, error)) *MockUserRepo_CountUsers_Call {
	_c.Call.Return(run)
	return _c
}
...
// SetEmailVerified provides a mock function for the type MockUserRepo
func (_mock *MockUserRepo) SetEmailVerified(ctx context.Context, userID int, emailVerified bool) error {
	ret := _mock.Called(ctx, userID, emailVerified)
	...
	if returnFunc, ok := ret.Get(0).(func(context.Context, int, bool) error); ok {
		r0 = returnFunc(ctx, userID, emailVerified)
	} else {
		r0 = ret.Error(0)
	}
	return r0
...
// MockUserRepo_SetEmailVerified_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SetEmailVerified'
type MockUserRepo_SetEmailVerified_Call struct {
	*mock.Call
}
...
//   - userID int
//   - emailVerified bool
func (_e *MockUserRepo_Expecter) SetEmailVerified(ctx any, userID any, emailVerified any) *MockUserRepo_SetEmailVerified_Call {
	return &MockUserRepo_SetEmailVerified_Call{Call: _e.mock.On("SetEmailVerified", ctx, userID, emailVerified)}
}

func (_c *MockUserRepo_SetEmailVerified_Call) Run(run func(ctx context.Context, userID int, emailVerified bool)) *MockUserRepo_SetEmailVerified_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockUserRepo_SetEmailVerified_Call) Return(err error) *MockUserRepo_SetEmailVerified_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockUserRepo_SetEmailVerified_Call) RunAndReturn(run func(ctx context.Context, userID int, emailVerified bool) error) *MockUserRepo_SetEmailVerified_Call {
	_c.Call.Return(run)
	return _c
}
...
type MockUserRepo_UpdateName_Call struct {
	*mock.Call
}
...
func (_e *MockUserRepo_Expecter) UpdateName(ctx any, userID any, name any) *MockUserRepo_UpdateName_Call {
	return &MockUserRepo_UpdateName_Call{Call: _e.mock.On("UpdateName", ctx, userID, name)}
}
